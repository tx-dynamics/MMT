...
style={{width:'90%',alignSelf:'center',marginTop:15,}}>
          <Text style={{
            ...
            color:'#ED6877',marginTop:5,}}>{`${moment( item.date).format('D MMM')} - ${moment(item.enddate).format('D MMM')}`}</Text>
           ...
           <View style={{width:'30%',borderRightWidth:0.5,borderColor:'#DBD8D8',alignItems:"center"}}>
            ...
            <View style={{flexDirection:'row'}}>
             <Text style={{
            fontsize:11,fontWeight:'400',color:'#BEBEBE',textAlign:'center'}}>{moment( item.date).format('D MMM')}</Text>
            </View>
          </View>
          <View style={{width:'30%',alignItems:"center",borderRightWidth:0.5,borderColor:'#DBD8D8'}}>
            ...
            <View style={{flexDirection:'row'}}>
             <Text style={{
            fontsize:11,fontWeight:'400',color:'#BEBEBE',textAlign:'center'}}>{moment( item.lastDate).format('D MMM')}</Text>
            </View>
          </View>
          <View style={{width:'30%',alignItems:"center",}}>
            ...
            <View style={{flexDirection:'row'}}>
             <Text style={{
            fontsize:11,fontWeight:'400',color:'#BEBEBE',textAlign:'center'}}>5 days</Text>
            </View>
          </View>
          </View>
         </View>
        ...
        justifyContent:'space-between'}}>
          <View style={{padding:15,elevation:5,borderRadius:6,
           ...
           shadowRadius: 3.84,
            ...
            <Text style={{
            fontFamily:Fonts.Poppins,
            fontsize:15,fontWeight:'700',color:'black'}}>05</Text>
             <Text style={{
          ...
          <View style={{padding:15,elevation:5,borderRadius:6,
           ...
           shadowRadius: 3.84,marginLeft:5
            ...
            <Text style={{
            fontFamily:Fonts.Poppins,
            fontsize:15,fontWeight:'700',color:'black'}}>06</Text>
             <Text style={{
            fontsize:9,fontWeight:'400',color:'#BEBEBE',marginLeft:5,top:1}}>Days</Text>
            </View>
          </View>
          <View style={{padding:15,elevation:5,borderRadius:6,shadowColor: '#000',backgroundColor: '#fff',
            ...
            <Text style={{
            fontFamily:Fonts.Poppins,
            fontsize:15,fontWeight:'700',color:'black'}}>{cl}</Text>
             <Text style={{
            fontsize:9,fontWeight:'400',color:'#BEBEBE',marginLeft:5,top:1}}>Days</Text>
            </View>
