  ...
  return (
    ...
    >
      ...
      {!show ? <TouchableOpacity
        ...
        <Text style={{
          color: '#FFB5CC', fontWeight: '300', fontSize: 15,
          fontFamily: Fonts.Poppins
        }}>{phone === '' ? '+92' : phone.slice(0, 3)}</Text>
      ...
      <TouchableOpacity
        ...
        onPress={() => { onphone() }}
        style={{
          borderColor: '#FFB5CC', borderWidth: 1, backgroundColor: theme.colors.primary,
